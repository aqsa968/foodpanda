...
import 'package:foodpanda/screens/cart/cart_viewmodel.dart';
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  GlobalVariables.cartList[index].name != null
                                      ? GlobalVariables.cartList[index].name!
                                      : 'N/A',
                                  maxLines: 2,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  GlobalVariables.cartList[index].price != null
                                      ? 'Rs: ${GlobalVariables.cartList[index].price!}'
                                      : 'N/A',
                                  style: const TextStyle(
                                    fontSize: 14,
